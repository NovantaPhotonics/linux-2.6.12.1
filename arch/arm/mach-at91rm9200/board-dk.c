...
static void __init dk_map_io(void)
{
	...
	at91rm9200_map_io();
	/* Initialize clocks */
	at91_main_clock = 180000000;		/* from 18.432 MHz crystal (18432000 / 4 * 39) */
	at91_master_clock = 60000000;		/* peripheral clock (at91_main_clock / 3) */
	at91_pllb_clock = 0x102F3E08;		/* (18.432 / 14 * 73) /2 = 47.9714  */
...
static struct at91_eth_data __initdata dk_eth_data = {
	.phy_irq_pin	= AT91_PIN_PA23,/* Changed for Flyer board*/
	.is_rmii	= 0,/* Changed for Flyer board*/
};
...
static struct at91_udc_data __initdata dk_udc_data = {
	.vbus_pin	= AT91_PIN_PA21,/* Changed for Flyer board*/
	.pullup_pin	= AT91_PIN_PA22,/* Changed for Flyer board*/
};
